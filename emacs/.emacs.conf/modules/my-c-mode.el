(defun c-mode-setup ()
    ...
    ;; Lay window out
    (define-key c-mode-base-map [(meta l)] 'c-window-layout)

    ;; Insert inclusion
    (define-key c-mode-base-map [(control c) (control i)] 'c-insert-include-bouncer)

    ;; Rebox comment
    (define-key c-mode-base-map [(meta q)] 'my-rebox-comment)

    ;; Show debugger
    (define-key c-mode-base-map [(control c) (d)] 'my-gdb)

    ;; Run program
    (define-key c-mode-base-map [(control c) (r)] 'my-gdb-run)

    ;; Stop program
    (define-key c-mode-base-map [(control c) (s)] 'my-gdb-stop)

    ;; Kill program
    (define-key c-mode-base-map [(control c) (k)] 'my-gdb-kill)
)
